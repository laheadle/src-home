...
#+begin_src sh :exports none
cd ~/extern/org-mode && git describe HEAD
#+end_src
...
In the example above I have =~/extern/client2= in a separate git
repository from ~/extern/org.  This gives me the flexibility of leaving
...
=org-agenda-files= on this laptop does not include the =~/extern/client2=
directory.
** Org File Structure
:PROPERTIES:
...
for any org files under =~/extern/doc.norang.ca/someclient/= if that is
...
creates date entries in the =~/extern/org/diary.org= file.
...
~/extern/bzflag/trunk/bzflag/src/bzflag/bzflag -directory ~/extern/bzflag/trunk/bzflag/data $*
