...
#+END_SRC
* Fundamental installation of org-mode
org-plus-contrib is not a real package with a feature, but we need it loaded anyway
see [[https://github.com/jwiegley/use-package/issues/597][here]], But I am still confused about why this works.
the archive org is being deprecated.
#+begin_example
...
** source code
*** Use the key for save file to save the buffer
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
*** Use the proper modes for source code
#+begin_src emacs-lisp
(eval-after-load "org"
...
#+end_src
*** scanning for links. Run this only when needed.
**** mywork
***** Scan a bunch of files for link locations
#+begin_src emacs-lisp
...
#+end_src
[[file:roam/perm/20210607135800-eopsm_5076_eat_api_update_class_export_endpoint_to_support_exporterrole_and_exporterxid_parameters.org][notes]]
**** Insert a link to a jira ticket
#+begin_src emacs-lisp
