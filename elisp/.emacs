...
(defhydra my-main-hydra (:color red :foreign-keys run)
  ...
  (">" next-buffer nil)
  ("a" avy-goto-char "avy-goto-char" :column "Move")
  ("h" avy-goto-word-1 "avy-goto-word-1")
  ...
  ("n" my-go-and-clock-in "my-go-and-clock-in" :column "Org-Move")
  ("u" my-go-and-clock-out "my-go-and-clock-out")
  ("g" org-forward-heading-same-level "org-forward-heading-same-level")
