  ...
  (progn
    ...
    (setq org-super-agenda-groups
          '((:todo "HOLD" :todo "WAITING" :order 300)
            ...
            (:name "C: This month: March" :priority "C")
            (:name "D: This quarter: Q1" :priority "D")
            (:name "E: This half-year: Q3 2020" :priority "E")
            (:name "F: Within a Year (Q1 2021)" :priority "F")
            (:name "G: Within two Years (Q1 2022)" :priority "G")
            ))))
...
(bind-key "C-x x" 'l-switch-to-partner-file global-map)
